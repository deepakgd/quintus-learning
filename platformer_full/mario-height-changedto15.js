window.addEventListener("load",  function(){
    ...
    console.log("mario  height changed 15 initialized...");
  ...
  var isRemovedBg = false;
    ...
    Q.scene("mario", function(stage){
        Q.stageTMX("mario-height-changedto15.tmx",stage);
    ...
    // Q.loadTMX("mario-height-changedto15.tmx, collectables.json, enemies.json, player.json, player.png", function() {
    Q.loadTMX("mario-height-changedto15.tmx,  enemies.json, player.json, player.png", function() {
